...
- 仓库内主要是**浓缩了个人阅读和思考精华的[自写讲义](roadmap.md)** （GitHub 阅读体验差，建议在本地使用 Typora），发布版 PDF 见 [Releases](https://github.com/leo-grayrat/convstencil-reading-log/releases/tag/Handout)。
...
- `experiments` 文件夹内是在 [#59](https://github.com/leo-grayrat/convstencil-reading-log/issues/59) 的启发下进行的临时实验。
  ...
  - 关于我如何想到一个足以做实验的 idea 这件事，其经历和思考过程可参考 [AI 总结](docs/无重叠算法%20提出思路总结.md)。
